...
const crearUsuario = async (datosUsuario) => {
    ...
    try {
        ...
        const insertQuery = `
            ...
            VALUES ($1, $2, $3, $4, TRUE)
            RETURNING usuario_id, nombre, email, is_active, requiere_evidencia_pago, fecha_registro
        `;
...
const listarUsuarios = async () => {
    ...
    try {
        const query = `
            SELECT 
                u.usuario_id, u.nombre, u.email, u.is_active, 
...
const actualizarUsuario = async (usuarioId, datos) => {
    const { nombre, email, password, requiere_evidencia_pago } = datos;
    const client = await db.connect();
    ...
    try {
        ...
        const updateQuery = `
            ...
            RETURNING usuario_id, nombre, email, is_active, requiere_evidencia_pago
        `;
